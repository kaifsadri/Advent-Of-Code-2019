...
for row in range(1, len(grid) - 1):
    for column in range(1, width - 1):
        if 35 == grid[row][column]:
            if (
                grid[row - 1][column] == 35
                and grid[row + 1][column] == 35
                and grid[row][column - 1] == 35
                and grid[row][column + 1] == 35
                and grid[row + 1][column + 1] == 46
                and grid[row - 1][column - 1] == 46
                and grid[row + 1][column - 1] == 46
                and grid[row + 1][column - 1] == 46
            ):
...
print(f"The sum of all alignment parameters is {result}.")
